package co.nilin.mixchange.port.order.redis.service

import co.nilin.mixchange.matching.core.model.PersistentOrderBook
import co.nilin.mixchange.matching.core.spi.OrderBookPersister
import org.springframework.beans.factory.annotation.Qualifier
import org.springframework.data.redis.core.ReactiveRedisTemplate
import org.springframework.stereotype.Component

@Component
class OrderBookRedisPersister(@Qualifier("snapshotRedisTemplate")
                              val redisTemplate: ReactiveRedisTemplate<String, PersistentOrderBook>) : OrderBookPersister {
