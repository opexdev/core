...
@Service
class FiatScannerSignatureVerifier(
    @Value("\${app.fiat-scanner.public-key}") private val publicKeyPem: String,
    @Value("\${app.fiat-scanner.signature-algorithm:SHA256withRSA}") private val signatureAlgorithm: String
) {

    fun verify(payload: String, signatureBase64: String) {
