...
(
    ...
    dest_wallet INTEGER NOT NULL REFERENCES wallet
(
    id
),
...
(
    ...
    owner_id INTEGER NOT NULL REFERENCES wallet_owner
(
    id
),
    tx_id INTEGER NOT NULL REFERENCES transaction
(
    id
),
    currency VARCHAR
...
(
    ...
    owner INTEGER REFERENCES wallet_owner
(
    id
),
    action VARCHAR
...
(
    ...
    wallet_id INTEGER REFERENCES wallet
(
    id
),
    daily_total DECIMAL,
...
(
    ...
    req_transaction_id VARCHAR
(
    20
) NOT NULL UNIQUE,
    final_transaction_id VARCHAR
(
    20
) UNIQUE,
    currency VARCHAR
...
(
    ...
    wallet INTEGER NOT NULL REFERENCES wallet
(
    id
),
...
(
    ...
    gateway_uuid VARCHAR
(
    256
) NOT NULL UNIQUE DEFAULT uuid_generate_v4
(
),
...
(
    ...
    gateway_id BIGINT NOT NULL REFERENCES currency_off_chain_gateway
(
    id
)
  ON DELETE CASCADE,
