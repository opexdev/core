...
@Component
class FIActionResponseSubmitter(private val template: KafkaTemplate<String, FinancialActionResponseEvent>) :
    FiActionResponseEventSubmitter {

    private val logger = LoggerFactory.getLogger(FIActionResponseSubmitter::class.java)
