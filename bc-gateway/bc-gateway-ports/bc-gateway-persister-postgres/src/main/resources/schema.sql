...
(
    ...
    addr_type_id INTEGER NOT NULL REFERENCES address_types
(
    id
),
...
(
    ...
    address_type INTEGER NOT NULL REFERENCES address_types
(
    id
),
    UNIQUE
