CREATE TABLE IF NOT EXISTS currency_on_chain_gateway_localization
(
    id                   SERIAL PRIMARY KEY,
    gateway_id           BIGINT      NOT NULL REFERENCES currency_on_chain_gateway (id) ON DELETE CASCADE,
...
INSERT INTO currency_on_chain_gateway_localization (gateway_id,
                                                    deposit_description,
