...
//    override suspend fun addCurrencyImplementationV2(currencySymbol: String, implementationSymbol: String, currencyName: String, chain: String, tokenName: String?, tokenAddress: String?, isToken: Boolean, withdrawFee: BigDecimal, minimumWithdraw: BigDecimal, isWithdrawEnabled: Boolean, decimal: Int): CurrencyImplementation? {
//        TODO("Not yet implemented")
//    }
...
//                        this.withdrawAllowed = isWithdrawEnabled
//                        this.withdrawFee = withdrawFee
//                        this.withdrawMin = minimumWithdraw
//                    }
//                    currencyImplementationRepository.save(it).awaitSingleOrNull()?.let { icm -> projectCurrencyImplementation(icm) }
//                }
//
//
//    }
...
//    }
    ...
    override suspend fun addCurrencyImplementation(
        ...
        return projectCurrencyImplementation(model)
    }
...
//                val currency = currencyRepository.findBySymbol(it.currencySymbol).awaitFirstOrNull()
                    projectCurrencyImplementation(it)
                }
    }
...
//        val currency = Currency(currencyModel.symbol, currencyModel.name)
        val implementations = currencyImplModel.map { projectCurrencyImplementation(it) }
        return CurrencyInfo(symbol, implementations.toList())
    }
...
//            currencyModel ?: currencyRepository.findBySymbol(currencyImplementationModel.currencySymbol).awaitSingle()
            return CurrencyImplementation(
                    currencyImplementationModel.currencySymbol,
                    currencyImplementationModel.implementationSymbol,
                    currencyImplementationModel.chain,
                    currencyImplementationModel.isToken,
                    currencyImplementationModel.tokenAddress,
                    currencyImplementationModel.tokenName,
                    currencyImplementationModel.withdrawAllowed,
