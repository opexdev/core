...
class BankAccountController(
    ...
    @Operation(
        ...
        description = """
    POST /opex/v1/bank-account.
    Bearer user-token required. Requires authenticated user JWT.
    ...
    @Operation(
        ...
        description = """
    DELETE /opex/v1/bank-account/{id}.
    Bearer user-token required. Required authority: PERM_bank_account:write.
            """,
        security = [SecurityRequirement(name = "bearerAuth")],
        responses = [
