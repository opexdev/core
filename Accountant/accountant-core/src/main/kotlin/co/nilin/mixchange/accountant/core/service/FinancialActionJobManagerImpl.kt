...
class FinancialActionJobManagerImpl(val financialActionLoader: FinancialActionLoader, val financialActionPersister: FinancialActionPersister, val walletProxy: WalletProxy) : FinancialActionJobManager {
