...
class FinancialAction(
    ...
    constructor( parent: FinancialAction?,
                 eventType: String,
                 pointer: String,
                 symbol: String,
                 amount: BigDecimal,
                 ...
                 createDate: LocalDateTime) : this(null, parent, eventType, pointer, symbol, amount, sender, senderWalletType, receiver, receiverWalletType, createDate) {
