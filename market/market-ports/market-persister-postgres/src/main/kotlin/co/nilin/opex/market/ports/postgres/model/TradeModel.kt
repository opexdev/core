...
class TradeModel(
    ...
    @Column("taker_commission") val takerCommission: BigDecimal?,
    @Column("maker_commission") val makerCommission: BigDecimal?,
    @Column("taker_commission_asset") val takerCommissionAsset: String?,
    @Column("maker_commission_asset") val makerCommissionAsset: String?,
