...
init_secrets() {
  ...
  vault write auth/app-id/map/app-id/opex-storage value=backend-policy display_name=opex-storage


  ## Enable user-id
  vault write auth/app-id/map/user-id/${BACKEND_USER} \
  value=opex-wallet,opex-websocket,opex-eventlog,opex-auth,opex-accountant,opex-matching-gateway,opex-api,opex-market,opex-bc-gateway,opex-payment,opex-admin,bitcoin-scanner,ethereum-scanner,tron-scanner,scanner-scheduler,scanner-liaison,opex-referral,opex-profile,opex-kyc,opex-device-management,opex-price-management,opex-otp,opex-storage
  ...
  vault write auth/app-id/login/opex-storage user_id=${BACKEND_USER}
  ...
  vault kv put secret/opex-api dbusername=${DB_USER} dbpassword=${DB_PASS} db_read_only_username=${DB_READ_ONLY_USER} db_read_only_pass=${DB_READ_ONLY_PASS} api_crypto_key=${API_CRYPTO_KEY}
  ...
  vault kv put secret/opex-storage dbusername=${DB_USER} dbpassword=${DB_PASS} db_read_only_username=${DB_READ_ONLY_USER} db_read_only_pass=${DB_READ_ONLY_PASS}
