...
import co.nilin.opex.config.app.dto.UpdateConfigRequest
...
class UserConfigController(private val userConfigManager: UserConfigManager) {
    ...
    @PostMapping("/{uuid}")
    fun updateConfig(@PathVariable uuid: String, @RequestBody request: UpdateConfigRequest): UserWebConfig {
        request.apply {
